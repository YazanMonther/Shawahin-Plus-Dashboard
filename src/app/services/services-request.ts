...
export class ServicesRequestService {
  private getAllRequests = 'servicerequests/GetAll';
  private getById = 'servicerequests/GetById';
  private acceptRequestUrl = 'Services/Add';
  private authToken = this.localStorageService.getToken();
  private deleteRequest = 'servicerequests/Remove';
  private denayRequestUrl = 'servicerequests/Denay';
  ...
  getAll = () =>
    this.Http.get<any[]>(`${baseurl}/${this.getAllRequests}`, {
